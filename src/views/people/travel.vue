...
<template>
  <div class="errPage-container">
    ...
    <div id="MinigrateChart"></div>
    <div class="select">
      <el-form label-width="110px">
        <el-form-item label="人群类型选择：">
          <el-select v-model="value" placeholder="请选择人群类型">
            <el-option
...
export default {
  ...
  methods: {
    chartMap() {
      let minigrateChart = this.$echarts.init(
        document.getElementById("MinigrateChart")
      );
      let geoCoordMap = {
        上海: [121.4648, 31.2891],
        东莞: [113.8953, 22.901],
