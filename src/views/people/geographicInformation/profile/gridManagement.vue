...
.page-box-two
  ...
  //- 添加网格
  el-dialog(title="添加小区", :visible.sync="addGrids")
    .dialog-main
      el-form(
        label-position="labelPosition",
        label-width="100px",
        ...
        el-form-item(label="小区类型:")
          el-select(v-model="add.gridType", placeholder="请选择小区类型")
            el-option(
  ...
  data() {
    return {
      ...
      add: {
        ...
        gridType: "",
        data: [
          { zoneTypeName: "成型小区", zoneTypeId: "1" },
          { zoneTypeName: "非成型小区", zoneTypeId: "2" },
          { zoneTypeName: "城镇", zoneTypeId: "3" },
          { zoneTypeName: "农村", zoneTypeId: "4" },
        ],
        gridHouse: "",
      },
      updateHistory: {
