<template lang="pug">
    .page-box-one
        ...
        el-dialog(title="编辑基本信息" :visible.sync="dialogData.dialogAreaEdit" @close='closeAreaDialog')
            ...
            .dialog-main
                el-form(label-position="labelPosition" label-width="100px" :model="dialogData.houseMainLeft.data" :rules="rules.edit" ref="postData")
                    el-form-item(label="包区名称" prop="zoneName")
        ...
        //- 添加网格
        el-dialog(title="添加网格" :visible.sync="dialogData.addGrid.dialogAreaGrid" @close="closeGridDialog")
            .dialog-main
                el-form(label-position="labelPosition" label-width="100px" :model="dialogData.addGrid" :rules="rules.grid" ref="postData")
                    ...
                    el-form-item(label="网格地址:" prop="gridHouse")
        ...
        data() {
            return {
                ...
                rules: {
                    edit: {
                        zoneName: [
                            { required: true, message: '请输入包区名称', trigger: 'blur' }
                        ],
                    },
                    declare: {
                        roomCnt: [
                    ...
                    grid: {
                        ...
                        gridHouse: [
                            { required: true, message: '请输入网格地址', trigger: 'blur' }
                        ],
                    }
                }
            }
