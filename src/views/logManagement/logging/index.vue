    ...
    <el-table v-loading="loading" :data="list" style="width: 100%;">
      ...
      >
        <template slot-scope="scope">
          <span>{{ transformDateFormat(scope.row.operTime) }}</span>
        </template>
      </el-table-column>
      <el-table-column
        label="主机IP"
      ...
      />
      <el-table-column label="操作用户" align="center" prop="operName" />
      <el-table-column
        label="操作状态"
        align="center"
        prop="status"
    ...
    <el-dialog title="操作日志详细" :visible.sync="open" width="700px">
      <el-form ref="form" :model="form" label-width="100px" size="mini">
        <el-row>
          ...
          <el-col :span="12">
            <el-form-item label="日志记录时间：">{{
              transformDateFormat(form.operTime)
            }}</el-form-item>
          </el-col>
          <el-col :span="24">
