      ...
      <el-col :span="18" :xs="24">
        ...
        <el-table v-loading="loading" :data="userList">
          ...
          <el-table-column label="创建时间" align="center" prop="createTime" width="160">
            <template slot-scope="scope">
              <span>{{ transformDateFormat(scope.row.createTime) }}</span>
            </template>
          </el-table-column>
          <el-table-column
            label="操作"
        ...
        <el-row>
          ...
          <el-col :span="12">
            <el-form-item label="归属部门" prop="deptId">
              <el-cascader
                ref="cascaderSelect"
                :props="{ checkStrictly: true,lazy: true,lazyLoad: loadHandleNode,leaf: 'isLeaf', value: 'id'}"
...
export default {
    ...
    return {
      ...
      cascaderProps: {
        ...
        async lazyLoad(node, resolve) {
          ...
          console.log(this);
          this.getTreeselect("");
          const data = await this.getTreeselect(node.data.id || "");
          resolve(data);
          // const { level } = node;
          // setTimeout(() => {
  ...
  methods: {
    ...
    reset() {
      ...
      this.resetForm("form");
      this.$nextTick(() => {
        this.$refs["cascaderSelect"] &&
          this.$refs["cascaderSelect"].handleClear();
      });
    },
    /** 搜索按钮操作 */
    handleQuery() {
    ...
    async loadHandleNode(node, resolve) {
      const data = await this.getTreeselect(
